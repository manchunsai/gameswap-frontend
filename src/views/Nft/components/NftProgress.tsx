...
import { Card, CardBody, Heading, OpenNewIcon, Text, Link as UIKitLink, Progress } from '@gameswapfinance/uikit'
        ...
        <InfoRow>
          ...
          <div>
            {!isInitialized ? (
              ...
              <Link href={`https://quickswap.exchange/block/${endBlockNumber}`} target="_blank" rel="noreferrer noopener">
